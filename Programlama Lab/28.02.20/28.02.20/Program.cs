...
namespace _28._02._20
{
    ...
    {//kromozom methodu, çaprazlama methodu, mutasyon methodu
        private static int[] BEKLENEN = new int[4];
        private static int iterasyon = 1;

        private static int Eslesme(int[] istenen, int[] gelen)
        {
            int eslesme = 1;
        ...
        private static int[] Caprazla(int[] annegelen, int[] babagelen)
        {
        ...
        private static int[] Mutasyon(int[] caprazlanan)
        {
